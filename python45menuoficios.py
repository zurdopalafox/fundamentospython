...
for oficio in micursor:
    oficios[i] = oficio[0] # SINO SE PONE EL [0] imprime raro con {,} por que el cursor devuelve una tupla aunque sea un solo campo
    i = i + 1
...
misql = "select * from EMP where oficio = :oficioseleccionado"
